...
import dev.codenmore.tilegame.entities.statics.SpriteCapacitor;
...
public class World {
	...
	public World(Handler handler, String path){
		...
		entityManager.addEntity(new SpriteNPC(handler, 200,200));
		entityManager.addEntity(new SpriteNPC(handler, 300,200));
		entityManager.addEntity(new SpriteNPC(handler, 900,250));
		entityManager.addEntity(new SpriteNPC(handler, 550,270));
		loadWorld(path);
